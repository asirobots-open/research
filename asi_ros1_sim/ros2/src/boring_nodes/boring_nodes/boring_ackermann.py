...
class BoringAckermann(Node):
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(Odometry, odometry_topic, 10)        
        self.subscriber_ = self.create_subscription(AsiTBSG, command_topic, self.cmdCb, 10)
    ...
    def cmdCb(self, msg):
        self.ack.command.propulsive_force = msg.throttle_cmd * self.ack.model.mass * msg.gear_cmd # gear_cmd = -1,0,1?
